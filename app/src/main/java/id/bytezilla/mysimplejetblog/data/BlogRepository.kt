        ...
        if (dummyBlogs.isEmpty()) {
            val blogs = listOf(
                ...
                Blog(
                    ...
                    imageUrl = R.drawable.coroutines,
                ...
                Blog(
                    ...
                    imageUrl = R.drawable.navigation,
                    author = "Bytezilla Studio",
                    date = "May 22, 2025"
                ),
                Blog(
                    ...
                    imageUrl = R.drawable.optimizing,
                    author = "Rizki Kurniawan, S.Kom",
                    date = "May 25, 2025"
                ),
                Blog(
                ...
                Blog(
                    ...
                    imageUrl = R.drawable.work,
                    author = "Rizki Kurniawan, S.Kom",
                    date = "June 5, 2025"
                )
            )
            val formatter = DateTimeFormatter.ofPattern("MMMM d, yyyy", Locale.ENGLISH)
            val sortedBlogs = blogs.sortedByDescending { LocalDate.parse(it.date, formatter) }
            dummyBlogs.addAll(sortedBlogs)
        }
    }
